...
![](https://support.optisigns.com/hc/article_attachments/45229015845523)You can hit the **Run Test** button at the bottom to test the connection. If successful, it should return a **200 OK** response and provide JSON data.
