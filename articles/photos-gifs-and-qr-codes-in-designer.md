...
* [Photos](#Photos)
	...
	+ [Animate](#Animate)
	+ [Position](#Position)
	+ [Lock / Copy Style](#LockCopyStyle)
* [GIPHY](#GIPHY)
* [QR Codes](#QRCode)
* [Troubleshooting and FAQs](#Troubleshooting)
	+ [The GIF I put in my Split Screen app is getting cut off. Help!](#FAQ1)
...
![photos side menu options](https://support.optisigns.com/hc/article_attachments/42526906954259)
...
![photo top menu gif](https://support.optisigns.com/hc/article_attachments/42526890571539)
...
![filter button graphic](https://support.optisigns.com/hc/article_attachments/42526906955667)

The **Filter** option brings up the Side Menu, allowing you to select different filters to add to your photo:

![filter feature example](https://support.optisigns.com/hc/article_attachments/42526890574611)

### Crop

![crop button graphic](https://support.optisigns.com/hc/article_attachments/42526890575507)

The **Crop** option allows you to crop the selected photo or image.

![crop feature example](https://support.optisigns.com/hc/article_attachments/42526890576019)
...
![mask button graphic](https://support.optisigns.com/hc/article_attachments/42526906958099)

Clicking the **Mask** option will open up the Mask option on the **Side Menu**.

![mask feature example](https://support.optisigns.com/hc/article_attachments/42526906960531)
...
![replace button graphic](https://support.optisigns.com/hc/article_attachments/42526890578963)

The **Replace** option lets you replace the image or photo with an image off the current device. This can be accessed via the Top Menu, or the quick action bar:

![replace option top menu or quick action bar](https://support.optisigns.com/hc/article_attachments/43119130855827)

### Background Remover

![background remover button graphic](https://support.optisigns.com/hc/article_attachments/42526906962067)
...
![background remover example](https://support.optisigns.com/hc/article_attachments/42526890579859)

You’ll need to wait for a loading icon to finish:

![background remover loading graphic](https://support.optisigns.com/hc/article_attachments/42526906963091)

Once done, click **Save**, and the background will have disappeared.

### Link

![link button graphic](https://support.optisigns.com/hc/article_attachments/42526906963987)
...
![link options side menu](https://support.optisigns.com/hc/article_attachments/42526906964499)

Clicking **Add Link** will prompt you to enter a URL or select an asset:

![select asset screen](https://support.optisigns.com/hc/article_attachments/42526906964627)

Once a link or asset has been chosen, more options will appear in the Link Options section:

![link options full options](https://support.optisigns.com/hc/article_attachments/42526890584723)

Expanding the **Scale** section will provide this option for your asset:

![scale options](https://support.optisigns.com/hc/article_attachments/42526890585491)
...
![settings options](https://support.optisigns.com/hc/article_attachments/42526890586131)
...
![close & nav bar styler options](https://support.optisigns.com/hc/article_attachments/42526890586771)
...
![icon](https://support.optisigns.com/hc/article_attachments/42526906967699)
...
![icon with nav bar](https://support.optisigns.com/hc/article_attachments/42526906969875)

### Settings

![settings button graphic](https://support.optisigns.com/hc/article_attachments/42526906970643)

Selecting the **Settings** button will open the **Data Mapping** section on the Side Menu:

![settings option data mapping side menu](https://support.optisigns.com/hc/article_attachments/42526890589075)
...
![effects button graphic](https://support.optisigns.com/hc/article_attachments/42526906982291)
...
![effects side menu closed](https://support.optisigns.com/hc/article_attachments/42526890589715)
...
![background effects](https://support.optisigns.com/hc/article_attachments/42526890592915)

Expanding the **Opacity** section allows you to vary the opacity of the selected area - background and text together.

![opacity effects](https://support.optisigns.com/hc/article_attachments/42526906990995)

This can be adjusted via slider. Shown below is half opacity:

![opacity example](https://support.optisigns.com/hc/article_attachments/42526906995347)
...
![outline effects](https://support.optisigns.com/hc/article_attachments/42526906997779)

![outline example](https://support.optisigns.com/hc/article_attachments/42526906999699)
...
![shadow effects](https://support.optisigns.com/hc/article_attachments/42526907002387)
...
![shadow example](https://support.optisigns.com/hc/article_attachments/42526890612627)
...
![gradient effects](https://support.optisigns.com/hc/article_attachments/42526907004947)
...
![texture effects](https://support.optisigns.com/hc/article_attachments/42526907006995)

### Animate

![animate button graphic](https://support.optisigns.com/hc/article_attachments/42526907008403)
...
![animate side menu](https://support.optisigns.com/hc/article_attachments/42526890619923)
...
![position button graphic](https://support.optisigns.com/hc/article_attachments/42526907015059)
...
![position options side menu](https://support.optisigns.com/hc/article_attachments/42526890626707)
...
![lock and copy style button graphic](https://support.optisigns.com/hc/article_attachments/42526907016595)
...
![lock example](https://support.optisigns.com/hc/article_attachments/42526890629267)
...
![copy style example](https://support.optisigns.com/hc/article_attachments/42526890630675)
...
![giphy side menu](https://support.optisigns.com/hc/article_attachments/42526890634771)
...
![sticker gif emoji text example](https://support.optisigns.com/hc/article_attachments/42526890636819)
...
![position options side menu 2](https://support.optisigns.com/hc/article_attachments/42526890639251)
...
![qr code side menu options](https://support.optisigns.com/hc/article_attachments/42526907026579)
...
Here we'll solve some common issues our users may run into when using Photos, GIFs, or QR Codes in Designer.

### The GIF I put in my Split Screen app is getting cut off. Help!

When a GIF is added to a [Split Screen app](https://support.optisigns.com/hc/en-us/articles/360026559573-How-to-Create-and-Use-the-Split-Screen-App), the resolution will not carry over, and the GIF will appear cut off.

To fix this issue, follow the instructions in our [**How to Fix the Scaling Issue on OptiSticks**](https://support.optisigns.com/hc/en-us/articles/28026588373139-How-to-Fix-The-Scaling-Issue-on-OptiSigns-Android-Device-Gen-3)article. When you reach the **Display Size** menu, change the display size to **Smallest:**

![](https://support.optisigns.com/hc/article_attachments/45089067779219)This will fix the GIF and it will display properly.
