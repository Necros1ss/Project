...
* Display post from your profiles
	+ **IMPORTANT:** The Instagram Business app will only display posts from ***your profile**,* not anyone else's.
...
![mceclip0.png](https://support.optisigns.com/hc/article_attachments/4405006762003)* Name: Name of your Instagram Wall, this is the name of the wall in your asset list. It will **not** be displayed on your screens.
 ...
 **Note:**For hashtags, the app **mix** of **top posts** (popular posts all time, sorted by created time) **and recent post** (all post within the last 24 hours), however, the app cannot get the post older than 24-48h if the post is not popular (on Instagram's list of top posts). ## **That's all! Congratulations!**
