...
* Only Pinned Messages: only send pinned messages from your Slack channels to the OptiSigns Slack app.
...
If your Slack message has more than one image, we only fetch the first image to display.### Limitations:
