...
![complete folder nesting setup](https://support.optisigns.com/hc/article_attachments/43657735762323)Each layer will require fewer and fewer permissions. For example, here is the permission structure we’d want for the **Pacific** folder:
